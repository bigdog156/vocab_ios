...
//  vocabproject
//
//  Created by Developer on 15/06/2022.
//
...
struct PersistenceController {
    ...
    init(inMemory: Bool = false){
        ...
        container.loadPersistentStores(completionHandler: { (storeDescription, error) in
            if let error = error as NSError? {
                fatalError("Error in Persistenct \(error)")
            }
    ...
    static var preview: PersistenceController = {
        ...
        restaurant.info = "Searching for great breakfast eateries and coffee? This place is for you. We open at 6:30 every morning, and close at 9 PM. We offer espresso and espresso based drink, such as capuccino, cafe latte, piccolo and many more. Come over and enjoy great meal."
        ...
        do{
            ...
            fatalError("Error save Restaurant: \(nsError.userInfo)")
        }
        return result
